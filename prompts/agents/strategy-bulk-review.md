...
1. `query_transactions(tags=["needs-review"], count_only=true)` — understand backlog size. If zero, check `get_sync_status` for freshness, report "backlog clear" and exit.
