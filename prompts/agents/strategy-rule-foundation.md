...
4. Dry-run EVERY candidate before creating it: preview_rule reports how many transactions it would match and surfaces conflicts. Only proceed with rules whose preview is clean and high-precision — discard anything that over-matches or would fight a category a human already set.
