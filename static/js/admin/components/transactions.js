...
document.addEventListener('DOMContentLoaded', function() {
  ...
  bar.innerHTML = '<div class="flex items-center gap-2 bg-base-100 border border-base-300 rounded-2xl shadow-lg px-4 py-2.5 max-w-[calc(100vw-2rem)]">'
    ...
    + '</button>'
    + '<button type="button" id="bb-bulk-tag" class="btn btn-ghost btn-sm gap-2" title="Tag selected">'
  ...
  modal.innerHTML =
    ...
    + '<button type="button" id="bb-comment-confirm" class="btn btn-primary">Add comment</button>'
    + '</div>'
    + '</div>'
