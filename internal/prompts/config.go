...
var agentConfigs = map[string]AgentTypeConfig{
	"initial-setup": {
		...
		Icon:        "sparkles",
		Color:       "primary",
		Core:        []string{"base-context", "tool-reference", "review-guardrails", "strategy-initial-setup"},
		Default:     []string{"teller-categories", "rule-creation", "token-efficiency", "report-submission", "report-format"},
	...
	"bulk-review": {
		...
		Icon:        "layers",
		Color:       "primary",
		Core:        []string{"base-context", "tool-reference", "review-guardrails", "strategy-bulk-review"},
		Default:     []string{"teller-categories", "rule-creation", "token-efficiency", "report-submission", "report-format"},
		Optional:    []string{"gmail-integration", "account-linking", "category-system", "sync-management", "transaction-comments", "merchant-analysis"},
	},
	"quick-review": {
		...
		Icon:        "zap",
		Color:       "primary",
		Core:        []string{"base-context", "tool-reference", "review-guardrails", "strategy-quick-review"},
		Default:     []string{"token-efficiency", "report-submission"},
		Optional:    []string{"teller-categories", "rule-creation", "gmail-integration", "account-linking", "category-system", "sync-management", "transaction-comments", "merchant-analysis", "report-format"},
	},
	"routine-review": {
		Type:        "routine-review",
		...
		Icon:        "repeat",
		Color:       "success",
		Core:        []string{"base-context", "tool-reference", "review-guardrails", "strategy-routine-review"},
		Default:     []string{"rule-creation", "report-submission", "transaction-comments"},
		Optional:    []string{"teller-categories", "gmail-integration", "account-linking", "token-efficiency", "category-system", "sync-management", "merchant-analysis", "report-format"},
	},
	"spending-report": {
		...
		Default:     []string{"report-submission", "report-format", "category-system", "merchant-analysis"},
	...
	"anomaly-detection": {
		...
		Default:     []string{"report-submission", "report-format", "merchant-analysis", "account-linking"},
	...
	"custom": {
		...
		Optional: []string{
			"review-guardrails", "category-system", "rule-creation", "report-submission",
			"report-format", "account-linking", "teller-categories", "token-efficiency",
