...
var fieldAliases = map[string][]string{
	"minimal":    {"provider_name", "amount", "date"},
	"core":       {"id", "date", "amount", "provider_name", "iso_currency_code"},
	"category":   {"category", "provider_category_primary", "provider_category_detailed"},
...
func FilterTransactionFields(t TransactionResponse, fields map[string]bool) map[string]any {
	...
	for key, want := range fields {
		...
		case "provider_category_detailed":
			m["provider_category_detailed"] = t.ProviderCategoryDetailed
		case "provider_category_confidence":
			m["provider_category_confidence"] = t.ProviderCategoryConfidence
		case "provider_payment_channel":
			m["provider_payment_channel"] = t.ProviderPaymentChannel
		case "pending":
			m["pending"] = t.Pending
		case "created_at":
