...
func NewRouter(a *app.App, version string) http.Handler {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Get("/counterparties", ListCounterpartiesHandler(svc))
		r.Get("/counterparties/{id}", GetCounterpartyHandler(svc))
		...
		r.Group(func(r chi.Router) {
			...
			r.Post("/counterparties/{id}/transactions", AssignCounterpartyTransactionsHandler(svc))
			r.Delete("/counterparties/{id}/transactions/{txid}", UnlinkCounterpartyTransactionHandler(svc))
